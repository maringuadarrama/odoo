...
class SaleOrder(models.Model):
    ...
    def write(self, vals):
        ...
        if vals.get("partner_shipping_id") and self._context.get(
    ...
    def _select_date_planned(self, date_planneds):
        if self.picking_policy == "direct":
            return super()._select_date_planned(date_planneds)
    ...
    def _prepare_create_invoice_vals(self):
        invoice_vals = super(SaleOrder, self)._prepare_create_invoice_vals()
