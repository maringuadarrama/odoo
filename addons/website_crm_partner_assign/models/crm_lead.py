...
class CrmLead(models.Model):
    ...
    partner_assigned_id = fields.Many2one('res.partner', 'Assigned Partner', tracking=True, domain="[('company_id', 'in', (False, company_id))]", help="Partner this case has been forwarded/assigned to.", index='btree_not_null')
