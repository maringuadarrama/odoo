...
class ProjectProject(models.Model):
    ...
    def _get_expenses_profitability_items(self, with_action=True):
        ...
        sol_read_group = self.env['sale.order.line'].sudo()._read_group(
            ...
            ['amount_to_invoice_taxexc:sum', 'amount_invoiced_taxexc:sum'],
        )
        ...
        for order, product, currency, amount_to_invoice_taxexc_sum, amount_invoiced_taxexc_sum in sol_read_group:
            ...
            if product_id in expense_data_per_product_id:
                ...
                dict_invoices_amount_per_currency[currency]['invoiced'] += amount_invoiced_taxexc_sum
