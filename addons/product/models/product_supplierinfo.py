...
class SupplierInfo(models.Model):
    ...
    product_uom = fields.Many2one(related='product_tmpl_id.uom_po_id')
    price = fields.Float(
        'Price',
    ...
    min_qty = fields.Float(
        ...
        required=True,
        default=0.0,
        help="The quantity to purchase from this vendor to benefit from the price, "
    ...
    delay = fields.Integer(
        ...
        required=True,
        default=1,
        help="Lead time in days between the confirmation of the purchase order and "
             "the receipt of the products in your warehouse. Used by the scheduler "
             "for automatic computation of the purchase order planning.",
    )
