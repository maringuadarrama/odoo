...
class ProductCategory(models.Model):
    ...
    packaging_reserve_method = fields.Selection(
        ...
        default='partial',
        help='Reserve Only Full Packagings: will not reserve partial packagings. '
             'If customer orders 2 pallets of 1000 units each and you only have 1600 in stock, '
             'then only 1000 will be reserved\n'
             'Reserve Partial Packagings: allow reserving partial packagings. '
             'If customer orders 2 pallets of 1000 units each and you only have 1600 in stock, '
    ...
    removal_strategy_id = fields.Many2one(
        ...
        help='Set a specific removal strategy that will be used regardless of the source location '
             ...
             'Least Packages: FIFO but with the least number of packages possible '
