...
class StockPicking(models.Model):
    ...
    def _compute_products_availability(self):
        ...
        for picking in pickings:
            ...
            if any(
                ...
                forecast_date = max(
                    picking.move_ids.filtered("forecast_date_planned").mapped(
                        "forecast_date_planned"
                    ),
                    default=False,
                )
                if forecast_date:
    ...
    @api.depends("move_type", "move_ids.state", "move_ids.date")
    ...
    @api.depends("move_type", "move_ids.date_deadline")
    ...
    @api.depends("picking_type_code", "state", "move_ids.product_uom_qty")
    ...
    @api.depends("picking_type_id", "state", "move_ids")
    ...
    def _search_date_category(self, operator, value):
        ...
        return expression.AND(
            [[("date_planned", operator, value)] for operator, value in search_domain]
        )
