...
class StockWarehouseOrderpoint(models.Model):
    ...
    group_id = fields.Many2one(
        ...
        help='Moves created through this orderpoint will be put in this procurement group. '
             'If none is given, the moves generated by stock rules will be grouped into one big picking.'
    )
    ...
    @api.depends(
        'product_id', 'location_id', 'product_id.stock_move_ids', 'product_id.stock_move_ids.state',
