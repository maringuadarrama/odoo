...
class StockPackage_Level(models.Model):
    ...
    package_id = fields.Many2one(
        ...
        required=True,
        check_company=True,
        domain="[('location_id', 'child_of', parent.location_id), ('company_id', 'in', (False, company_id))]",
    )
    ...
    location_dest_id = fields.Many2one(
        ...
        readonly=False,
        precompute=True,
        domain="[('id', 'child_of', parent.location_dest_id), ('company_id', 'in', (False, company_id))]",
    )
            ...
            if package_level.is_fresh_package:
                ...
                package_level.is_done = (
                    package_level._check_move_lines_map_quant_package(
                        package_level.package_id, only_picked=True
                    )
                )
            ...
            if package_level.is_done:
                if not package_level.is_fresh_package:
                    ...
                    package_level.picking_id.move_line_ids.filtered(
                        ...
                        and ml.package_id == package_level.package_id
                    ).unlink()
