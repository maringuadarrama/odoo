                ...
                try:
                    if location.last_inventory_date:
                        days_until_next_inventory = (
                            location.cyclic_inventory_frequency - (fields.Date.today() - location.last_inventory_date).days
                        )
                        if days_until_next_inventory <= 0:
                            ...
                            location.next_inventory_date = (
                                location.last_inventory_date + timedelta(days=location.cyclic_inventory_frequency)
                            )
                    else:
