...
class ProductTemplate(models.Model):
    ...
    responsible_id = fields.Many2one(
        ...
        check_company=True,
        help='This user will be responsible of the next activities related to '
             'logistic operations for this product.',
    )
    property_stock_production = fields.Many2one(
        ...
        help='This stock location will be used, instead of the default one, as the source location '
             'for stock moves generated by manufacturing orders.',
    )
    property_stock_inventory = fields.Many2one(
        ...
        help='This stock location will be used, instead of the default one, as the source location '
             'for stock moves generated when you do an inventory.',
    )
    tracking = fields.Selection(
        ...
        compute='_compute_tracking', store=True, precompute=True,
        readonly=False,
    ...
    def write(self, vals):
        if 'company_id' in vals and vals['company_id']:
            ...
            if products_changing_company:
                ...
                if move:
                    raise UserError(_(
                        'This product\'s company cannot be changed as long as there are '
                        'stock moves of it belonging to another company.'
                    ))
                ...
                if quant:
                    raise UserError(_(
                        'This product\'s company cannot be changed as long as there are '
                        'quantities of it belonging to another company.'
                    ))
        ...
        if 'uom_id' in vals:
            ...
            if done_moves:
                raise UserError(_(
                    'You cannot change the unit of measure as there are already '
                    'stock moves for this product. '
                    'If you want to change the unit of measure, you should rather '
        ...
        if any(
            'is_storable' in vals
            and vals['is_storable'] != prod_tmpl.is_storable for prod_tmpl in self
        ):
            ...
            if existing_reserved_move_lines:
                raise UserError(_(
                    'You cannot change the inventory tracking of a product that is '
                    'currently reserved on a stock move. If you need to change the '
                    'inventory tracking, you should first unreserve the stock move.'
                ))
    ...
    def copy(self, default=None):
        ...
        for product in new_products.product_variant_ids:
            product_attribute_value = product.product_template_attribute_value_ids.\
        ...
        for storage_category_capacity in self.product_variant_ids.storage_category_capacity_ids:
            product_attribute_value = storage_category_capacity.\
    ...
    def _onchange_type(self):
        ...
        if (
            ...
            and self.env['stock.move.line'].sudo().search_count([
            ...
            res['warning'] = {
                ...
                'message': _(
                    ...
                    'It is not advised to change the Product Type since it can lead to '
                    'inconsistencies. '
                    'A better solution could be to archive the product and create '
                    'a new one instead.'
                )
            }
        return res
