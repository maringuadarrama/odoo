...
class StockRoute(models.Model):
    ...
    warehouse_ids = fields.Many2many(
        ...
        column1='route_id', column2='warehouse_id',
        string='Warehouses',
    ...
    warehouse_selectable = fields.Boolean(
        ...
        help='When a warehouse is selected for this route, this route should be seen '
             'as the default route when products pass through this warehouse.',
    )
    packaging_selectable = fields.Boolean(
        string='Applicable on Packaging',
