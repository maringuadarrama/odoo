...
class TestPacking(TestPackingCommon):
    ...
    def test_put_in_pack(self):
        ...
        self.assertEqual(
            len(pack_picking.package_level_ids),
            1,
            "Put some products in pack should create a package_level",
        )
        self.assertEqual(
            pack_picking.package_level_ids[0].state,
            "new",
        ...
        self.assertEqual(
            len(ship_picking.package_level_ids),
            2,
    ...
    def test_pick_a_pack_confirm(self):
        ...
        self.assertEqual(
            package_level.move_line_ids[0].quantity,
            20.0,
    ...
    def test_pack_in_receipt_two_step_single_putway(self):
        ...
        * In this internal transfer, adds the package then valid it.
        ...
        move_form = Form(
            receipt.move_ids_without_package[0], view="stock.view_stock_move_operations"
        )
        with move_form.move_line_ids.edit(0) as move_line:
            move_line.quantity = 1
        move_form = Form(
            receipt.move_ids_without_package[1], view="stock.view_stock_move_operations"
        )
        with move_form.move_line_ids.edit(0) as move_line:
            move_line.quantity = 1
        move_form.save()
        ...
        self.assertEqual(len(internal_transfer.package_level_ids), 1)
    ...
    def test_pick_another_pack(self):
        ...
        delivery.action_confirm()
        self.assertEqual(
            delivery.package_level_ids.package_id,
            pack1 | pack2,
