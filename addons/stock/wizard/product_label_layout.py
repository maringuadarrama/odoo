...
class ProductLabelLayout(models.TransientModel):
    ...
    def _get_zpl_label_placeholder(self):
        return base64.b64encode(
            file_open("stock/static/img/zpl_label_placeholder.png", "rb").read()
        )

    move_ids = fields.Many2many("stock.move")
    move_quantity = fields.Selection(
        [("move", "Operation Quantities"), ("custom", "Custom")],
    ...
    zpl_preview = fields.Image(
        "ZPL Preview", readonly=True, default=_get_zpl_label_placeholder
    )
    ...
    def _compute_zpl_preview(self):
        ...
        zpl = (
            self.env.ref(xml_id)
            ._render_qweb_text(xml_id, None, data=data)[0]
            .decode("utf-8")
        )
        ...
        if (
            ...
            for move in self.move_ids:
                ...
                if not float_is_zero(
                    useable_qty, precision_rounding=move.product_uom.rounding
                ):
