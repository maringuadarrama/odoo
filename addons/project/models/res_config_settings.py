...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        project_task_waiting_subtype_id = self.env.ref(
            "project.mt_project_task_waiting"
        )
        if task_waiting_subtype_id.hidden != (
            not self["group_project_task_dependencies"]
        ):
            task_waiting_subtype_id.hidden = not self["group_project_task_dependencies"]
            project_task_waiting_subtype_id.hidden = not self[
        ...
        rating_project_request_email_template = self.env.ref(
