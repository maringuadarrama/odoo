...
class FleetVehicle(models.Model):
    ...
    account_move_ids = fields.One2many(comodel_name='account.move', compute='_compute_move_ids')
    bill_count = fields.Integer(string='Bills Count', compute='_compute_move_ids')
