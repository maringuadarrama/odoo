...
class DeliveryCarrier(models.Model):
    ...
    def _get_packages_from_order(self, order, default_package_type):
        ...
        total_cost = 0
        for line in order.order_line_ids.filtered(lambda line: not line.is_delivery and not line.display_type):
    ...
    def _get_commodities_from_order(self, order):
        ...
        for line in order.order_line_ids.filtered(lambda line: not line.is_delivery and not line.display_type and line.product_id.type == 'consu'):
