    ...
    def _inverse_product_uom_qty(self):
        for line in self:
            if line.aml_id:
                ...
                # on POL, setting product_uom_qty will recompute price_unit to have the old value
                ...
                line.pol_id.product_uom_qty = line.product_uom_qty
    ...
    def _select_po_line(self):
        return SQL(
            ...
            SELECT
                ...
                pol.product_uom_qty AS line_qty,
            ...
            WHERE
                po.state = 'purchase'
                AND pol.product_uom_qty > pol.qty_invoiced
                OR (
