...
class PurchaseOrder(models.Model):
    ...
    def merge_orders(self):
        ...
        rfq_to_merge = self.filtered(lambda order: order.state == "draft")
    ...
    def _get_orders_to_remind(self):
        ...
        return self.search(
            ...
            lambda order: order.mapped("order_line_ids.product_id.product_tmpl_id.type")
            != ["service"]
        )
    ...
    def _can_confirm_has_lines(self):
        self.ensure_one()
        orders_without_lines = self.filtered(lambda order: not order.order_line_ids)
