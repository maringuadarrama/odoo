...
class PurchaseOrderLine(models.Model):
    ...
    product_uom_id = fields.Many2one(
        "uom.uom", string="Unit", domain="[('id', 'in', allowed_uom_ids)]"
    )
    ...
    price_unit_discounted = fields.Float(
        "Unit Price (Discounted)", compute="_compute_price_unit_discounted"
    )
    ...
    qty_received_manual = fields.Float(
        "Manual Received Qty", digits="Product Unit", copy=False
    )
