    ...
    def _hook_on_written_confirmed_lines(self, write_vals, previous_vals):
        ...
        for line in self:
            if (
                ...
                and float_compare(
                    previous_vals[line.id].get("previous_product_uom_qty"),
                    line.product_uom_qty,
            ...
            if (
                ...
                and float_compare(
                    previous_vals[line.id].get("previous_qty_transfered"),
                    line.qty_transfered,
                    precision_digits=precision,
                )
                != 0
                ...
                line.order_id.message_post_with_source(
                    ...
                    subtype_xmlid="mail.mt_note",
                    render_values={"line": self, "qty_transfered": line.qty_transfered},
                )
