...
class FleetVehicleLogContract(models.Model):
    ...
    name = fields.Char(
        string='Name',
        compute='_compute_contract_name', store=True,
        readonly=False,
    )
    ...
    def _compute_contract_name(self):
        for log in self:
            name = log.vehicle_id.name
            if name and log.cost_subtype_id.name:
                name = log.cost_subtype_id.name + ' ' + name
            log.name = name
    ...
    def _compute_has_open_contract(self):
        ...
        for log in self:
            log.has_open_contract = log.vehicle_id in open_contracts.vehicle_id
    ...
    def scheduler_manage_contract_expiration(self):
        ...
        # It manages the state of a contract, possibly by posting a message
        # on the vehicle concerned and updating its status
