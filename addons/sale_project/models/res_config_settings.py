...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        if self.group_project_milestone:
            # Search the milestones containing a SOL and change the qty_transfered_method field of the SOL and the
            ...
            self.env['sale.order.line'].sudo().search([('product_id', 'in', products.ids)]).qty_transfered_method = 'manual'
