...
class StockLot(models.Model):
    ...
    def _alert_date_exceeded(self):
        ...
        alert_activity_default_user_id = (
            alert_activity.default_user_id.id if alert_activity else None
        )
        for lot in alert_lots:
            user_id = (
                alert_activity_default_user_id
                or lot.product_id.with_company(lot.company_id).responsible_id.id
