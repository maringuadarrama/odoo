...
registry.category("web_tour.tours").add("sale_combo_configurator_preconfigure_unconfigurable_ptals", {
    url: "/odoo",
    steps: () => [
        ...
        productConfiguratorTourUtils.selectAttribute("Test product", "Attribute B", "B", "multi"),
