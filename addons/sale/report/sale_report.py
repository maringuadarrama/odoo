...
class SaleReport(models.Model):
    ...
    campaign_id = fields.Many2one(
        comodel_name="utm.campaign", string="Campaign", readonly=True
    )
    medium_id = fields.Many2one(
        comodel_name="utm.medium", string="Medium", readonly=True
    )
    source_id = fields.Many2one(
        comodel_name="utm.source", string="Source", readonly=True
    )
    ...
    untaxed_amount_to_invoice = fields.Monetary(
        string="Untaxed Amount To Invoice", readonly=True
    )
    untaxed_amount_invoiced = fields.Monetary(
        string="Untaxed Amount Invoiced", readonly=True
    )
