...
class SaleComboConfiguratorController(Controller):
    """Controller for handling combo product configuration in the sales module.
    ...
    def _get_combo_item_data(self, combo, combo_item, selected_combo_item, date, currency, pricelist, **kwargs):
        ...
        ) or any(ptav.is_custom for ptav in combo_item.product_id.product_template_attribute_value_ids)
