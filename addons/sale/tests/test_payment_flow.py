...
class TestSalePayment(AccountPaymentCommon, SaleCommon, PaymentHttpCommon):
    ...
    def test_11_so_payment_link(self):
        ...
        with patch(
            "odoo.addons.payment.controllers.portal.PaymentPortal" "._compute_show_tokenize_input_mapping"
        ) as patched:
    ...
    def test_invoice_is_final(self):
        ...
        with mute_logger("odoo.addons.sale.models.payment_transaction"), patch(
            "odoo.addons.sale.models.sale_order.SaleOrder._create_invoices", return_value=self.env["account.move"]
    ...
    def test_check_portal_access_token_before_rerouting_flow(self):
        ...
        with patch.object(CustomerPortal, "_document_check_access") as mock:
            ...
            self.assertEqual(mock.call_count, 0, msg="No check should be made when sale_order_id is not provided.")
            ...
            self.assertEqual(mock.call_count, 1, msg="The check should be made as sale_order_id is provided.")
    ...
    def test_check_payment_access_token_before_rerouting_flow(self):
        ...
        with patch.object(CustomerPortal, "_document_check_access", _document_check_access_mock), patch(
    ...
    def test_partial_payment_confirm_order(self):
        ...
        with patch(
            ...
            notification_mail_mock.assert_called_once_with(self.env.ref("sale.mail_template_sale_payment_executed"))
            self.assertEqual(self.sale_order.state, "draft")
            ...
            notification_mail_mock.assert_called_with(self.env.ref("sale.mail_template_sale_confirmation"))
            self.assertEqual(self.sale_order.state, "sale")
