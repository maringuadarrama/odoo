...
class StockRule(models.Model):
    ...
    def _get_partner_id(self, values, rule):
        return values.get("supplierinfo_name") or (
            values.get("group_id") and values.get("group_id").partner_id
        )
    ...
    def _prepare_purchase_order(self, company_id, origins, values):
        ...
        return {
            ...
            "purchase_user_id": partner.purchase_user_id.id,
    ...
    def _run_buy(self, procurements):
        ...
        for domain, procurements_rules in procurements_by_po_domain.items():
            ...
            grouped_po_lines = groupby(
                po.order_line_ids.filtered(
                    lambda l: not l.display_type
                    and l.product_uom_id == l.product_id.uom_id
                ),
    ...
    def _update_purchase_order_line(
        ...
        procurement_uom_po_qty = product_uom._compute_quantity(
            product_qty, uom, rounding_method="HALF-UP"
        )
        seller = product_id.with_company(company_id)._select_seller(
            partner_id=partner,
            quantity=line.product_uom_qty + procurement_uom_po_qty,
        ...
        res = {
            "product_qty": line.product_uom_qty + procurement_uom_po_qty,
