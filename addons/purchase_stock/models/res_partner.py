...
class ResPartner(models.Model):
    ...
    on_time_rate = fields.Float(
        ...
        help="Over the past x days; the number of products received on time "
             "divided by the number of ordered products."
             "x is either the System Parameter purchase_stock.on_time_delivery_days "
             "or the default 365"
    )
    ...
    def _compute_on_time_rate(self):
        date_order_days_delta = int(self.env["ir.config_parameter"].sudo().get_param(
