...
class StockMove(models.Model):
    ...
    def _get_valuation_price_and_qty(self, related_aml, to_curr):
        ...
        for val_stock_move in self:
            ...
            svl = val_stock_move.with_context(active_test=False).mapped(
    ...
    def _get_all_related_sm(self, product):
        return (
            super()._get_all_related_sm(product)
            | self.filtered(lambda m: m.purchase_line_id.product_id == product)
        )
    ...
    def _is_purchase_return(self):
        ...
        return self.location_dest_id.usage == "supplier" or (
            ...
            and self.location_dest_id == self.env.ref(
