...
class PurchaseOrder(models.Model):
    ...
    # is_shipped has been removed from purchase.order as it is not used anymore. lmmg
    ...
    def action_cancel(self):
        ...
        purchase_orders_with_receipt = self.filtered(
            lambda o: any(move.state == "done" for move in o.line_ids.move_ids)
        )
    ...
    def _log_decrease_ordered_quantity(self, purchase_order_lines_quantities):
        ...
        def _render_note_exception_quantity_po(order_exceptions):
            line_ids = self.env["purchase.order.line"].browse(
                [
                    order_line.id
            ...
            purchase_order_ids = line_ids.mapped("order_id")
